...
- 단축키 설정하기: 설정에서 > keyboard Shortcuts
- 검색어로 `postCSS Sorting:Run` 선택 : Shift + p
...
- 정리
  ...
  - `영역너비(650px) / 디자인 전체 영역 너비 (1280%) * 100 = 결과 vw`
  - `영역너비(400px) / 디자인 전체 영역 너비 (1280%) * 100 = 결과 vw`
  <!-- 자연스러운 반응형 계산법 -->
